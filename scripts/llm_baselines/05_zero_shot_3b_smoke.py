...
def main():
    ...
    (OUT_DIR / "zero_shot_3b_smoke_sample_ids.json").write_text(json.dumps(sample_ids, ensure_ascii=False, indent=2), encoding="utf-8")
    ...
    pred_path = OUT_DIR / "zero_shot_3b_smoke_predictions.csv"
    ...
    (OUT_DIR / "zero_shot_3b_smoke_config.json").write_text(json.dumps(config, ensure_ascii=False, indent=2), encoding="utf-8")
    ...
    print("\nSaved:")
    print(pred_path)
    print(OUT_DIR / "zero_shot_3b_smoke_config.json")
