...
METHOD = "qwen2_5_1_5b_zero_shot_pilot"
...
def main():
    ...
    (OUT_DIR / "zero_shot_pilot_sample_ids.json").write_text(json.dumps(sample_ids, ensure_ascii=False, indent=2), encoding="utf-8")
    ...
    (OUT_DIR / "zero_shot_pilot_config.json").write_text(json.dumps(config, ensure_ascii=False, indent=2), encoding="utf-8")
